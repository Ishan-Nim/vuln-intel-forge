...
const HeroSection = () => {
  return (
    <section className="bg-gradient-to-b from-background to-background/70 py-16 md:py-24 relative overflow-hidden dark:bg-none dark:bg-background">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-5xl font-bold mb-6 text-foreground dark:text-chatgpt-text-dark">
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary/80">
              AI Precision. Human Insight. Safer Code.
            </span>
          </h1>
          <h2 className="text-xl md:text-2xl font-medium mb-6 text-foreground dark:text-chatgpt-text-dark">
            Meet <span className="text-primary font-bold">Dr.Vulner 0/1</span> — Your AI-Powered Vulnerability Assistant
          </h2>
          <p className="text-lg mb-8 text-muted-foreground dark:text-chatgpt-text-dark/80 max-w-3xl mx-auto">
