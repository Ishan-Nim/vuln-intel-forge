...
const HeroSection = () => {
  return <section className="bg-gradient-to-b from-background to-accent py-16 md:py-24 relative overflow-hidden">
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-xl md:text-2xl font-medium mb-6">
            Meet <span className="text-primary font-bold">Dr.Vulner 	𝟶/𝟷</span> — Your AI-Powered Vulnerability Assistant
          </h2>
